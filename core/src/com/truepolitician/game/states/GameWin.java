...
public class GameWin extends State {
    ...
    public GameWin(GameStateManager gsm, int result) {
        super(gsm);
...
//        parameter2.shadowColor = new Color(0, 0, 0, 0.75f);
    ...
    public void render(SpriteBatch sb) {
        ...
        text3.setText(font2, "Успех!");
        font2.draw(sb, text3, camera.position.x - text3.width/2, camera.position.y + 170); // рисуем надпись "победа"
